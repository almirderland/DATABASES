...
students
ADD PRIMARY KEY (id);
INSERT INTO students VALUES ('12345','Almira','19','Tole bi 59','7014595588');
UPDATE students SET id = '54321' WHERE id = '12345';
DELETE FROM students WHERE name = 'Almira';
...
--Task 4
INSERT INTO customers values('1','Almira Khalitova','2021-09-23 02:37:30','Tole bi 59');
